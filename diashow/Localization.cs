    ...
    private static readonly IReadOnlyDictionary<AppLanguage, IReadOnlyDictionary<string, string>> Translations =
        new Dictionary<AppLanguage, IReadOnlyDictionary<string, string>>
        {
            [AppLanguage.English] = new Dictionary<string, string>
            {
                ...
                ["VideoPreviewUnavailable"] = "Preview unavailable",
                ["Previous"] = "Previous",
            ...
            [AppLanguage.German] = new Dictionary<string, string>
            {
                ...
                ["VideoPreviewLoading"] = "Vorschau wird geladen...",
                ["VideoPreviewUnavailable"] = "Vorschau nicht verfügbar",
                ["Previous"] = "Zurück",
                ...
                ["CreationDateOrder"] = "Erstellungsdatum",
            ...
            [AppLanguage.Spanish] = new Dictionary<string, string>
            {
                ...
                ["VideoPreviewLoading"] = "Cargando vista previa...",
                ["VideoPreviewUnavailable"] = "Vista previa no disponible",
                ["Previous"] = "Anterior",
                ...
                ["CreationDateOrder"] = "Fecha de creación",
